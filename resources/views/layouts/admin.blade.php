...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="{{ route('home') }}" class="logo d-flex align-items-center">
        <img src="assets/img/logo.png" alt="" class="w-lg">
  ...
  <aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
              ...
              <li>
                  <a href="{{ route('pemasok.index') }}">
                      <i class="bi bi-circle"></i><span>Info Pemasok</span>
                  </a>
              </li>

              @endif
              <!-- Menambahkan hanya tab Akses Pengguna -->
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('users.edit', auth()->user()->id) }}">
          <i class="bi bi-person"></i>
          <span>Profile</span>
        </a>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>MyLoan</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
